export const siteConfig = {
  ...
  accentColor: "#0284c7", // Sky-600 — digital, webmarketing
  highlightColor: "#06b6d4", // Cyan-500 — dynamic, creative pop
  ...
  experience: [
    ...
    },
    {
      company: "I.A.P.R.",
      title:
        "Gestionnaire ADV & Relation Clients, CRM, Chef de Projet IT",
      dateRange: "2007 – 2017",
      bullets: [
    ...
    },
    {
      ...
      dateRange: "2001 – 2002",
      bullets: [
        "Gestion des réservations en français, espagnol et anglais",
      ],
    },
    {
      company: "Chanel S.A.",
      ...
      dateRange: "1997 – 2001",
      bullets: [
        "Assistant au Laboratoire Pilote pour projets et production",
      ],
    },
  ],
  ...
  education: [
    {
      ...
      degree:
        "Executive MBA – Stratégies Web Marketing & Projets Communication Digitale",
      dateRange: "2020 – 2021",
    ...
    },
    {
      ...
      achievements: [
        "Mention Bien",
        "Titre certifié RNCP Niveau 6 (EU)",
      ],
    },
  ],
};
